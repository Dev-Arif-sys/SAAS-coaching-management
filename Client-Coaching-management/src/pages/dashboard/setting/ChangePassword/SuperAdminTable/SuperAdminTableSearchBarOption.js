...
import SuperAdminTableDetails from './SuperAdminTableDetails';

const SuperAdminTableSearchBarOption = () => {
            ...
            >
                ...
                {show ? (
                    ...
                    <SearchStudentsData data={[classes, batch, year]} />{' '} */}
                        <SuperAdminTableDetails data={[fromDate, toDate]}></SuperAdminTableDetails>
                    </>
                ) : (
                    ''
                )}
...
export default SuperAdminTableSearchBarOption;
